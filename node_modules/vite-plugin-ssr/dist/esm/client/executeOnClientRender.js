...
async function executeOnClientRender(pageContext, isClientRouter) {
    ...
    assertUsage(hookResult === undefined, `The ${hookName}() hook defined by ${hook.hookSrc} isn't allowed to return a value`);
}
...
function assertMissingHook(pageId, pageConfigs, url) {
    ...
    assert(!((_a = pageConfig.configSources.onRenderClient) === null || _a === void 0 ? void 0 : _a.configValue));
    assert(((_b = pageConfig.configSources.clientRouting) === null || _b === void 0 ? void 0 : _b.configValue) === true);
    ...
    const pageConfigFilesDefiningHook = [];
    let pageConfigFilesAll = [];
