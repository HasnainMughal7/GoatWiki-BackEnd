...
import { assert, assertUsage, hasProp, isPlainObject, objectAssign, getProjectError, serverSideRouteTo, callHookWithTimeout } from './utils';
...
async function onBeforeRenderExecute(pageContext) {
    ...
    if (hook) {
        ...
        const hookResult = await callHookWithTimeout(() => onBeforeRender(pageContextReadyForRelease), 'onBeforeRender', hook.hookSrc);
