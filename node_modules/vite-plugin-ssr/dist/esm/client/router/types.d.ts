...
export declare type PageContextBuiltInClient<Page = any> = Partial<PageContextBuiltIn<Page>> & Pick<PageContextBuiltIn<Page>, 'Page' | 'pageExports' | 'exports' | 'exportsAll' | 'url' | 'urlOriginal' | 'urlPathname' | 'urlParsed'> & {
