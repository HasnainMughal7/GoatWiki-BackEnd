...
async function resolveRouteFunction(routeFunction, allowAsync, pageContext, pageRouteFilePath) {
    ...
    assertUsage(!('pageContext' in result), 'Providing `pageContext` in Route Functions is forbidden, see https://vite-plugin-ssr.com/route-function#cannot-provide-pagecontext');
