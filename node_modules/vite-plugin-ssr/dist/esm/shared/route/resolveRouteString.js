...
function assertRouteString(routeString, errMsgPrefix) {
    ...
    assertUsage(routeString === '*' || routeString.startsWith('/'), `${errMsgPrefix} route string '${routeString}'${routeString === '' ? ' (empty string)' : ''}: route strings should start with a leading slash '/' (or be '*')`);
}
