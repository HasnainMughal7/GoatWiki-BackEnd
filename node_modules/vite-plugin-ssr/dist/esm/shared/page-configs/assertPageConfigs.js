        ...
        Object.entries(pageConfig.configSources).forEach(([configName, configSource]) => {
            ...
            if (configSource.codeFilePath2) {
                ...
                if (configName === 'route') {
                    ...
                    assertUsage(configValueType === 'string' || isCallable(configValue), `${codeFilePath2} has a default export with an invalid type '${configValueType}': the default export should be a string or a function`);
                }
            }
        });
    });
