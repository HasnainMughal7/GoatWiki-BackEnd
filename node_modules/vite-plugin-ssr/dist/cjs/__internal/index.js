...
async function getPagesAndRoutes() {
    ...
    const { pageFilesAll, pageConfigs, allPageIds } = await (0, getPageFiles_1.getPageFilesAll)(false, true);
    const { pageRoutes } = await (0, route_1.loadPageRoutes)(pageFilesAll, pageConfigs, allPageIds);
    return {
        pageRoutes,
        pageFilesAll,
        pageConfigs,
