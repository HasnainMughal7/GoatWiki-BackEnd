...
const isNpmPackageName_1 = require("./isNpmPackageName");
...
function getDependencyPackageJson(npmPackageName, userAppRootDir) {
    ...
    (0, assert_1.assert)((0, isObject_1.isObject)(packageJson));
    return packageJson;
}
...
function getDependencyPackageJsonPath(npmPackageName, userAppRootDir) {
    (0, assert_1.assert)((0, isNpmPackageName_1.isNpmPackageName)(npmPackageName));
    ...
    (0, assert_1.assertUsage)(packageJsonPath, `Cannot read ${npmPackageName}/package.json. Define package.json#exports["./package.json"] with the value "./package.json" in the package.json of ${npmPackageName}.`);
    packageJsonPath = (0, filesystemPathHandling_1.toPosixPath)(packageJsonPath);
    (0, assert_1.assert)(packageJsonPath.endsWith('/package.json'), packageJsonPath); // package.json#exports["package.json"] may point to another file than package.json
