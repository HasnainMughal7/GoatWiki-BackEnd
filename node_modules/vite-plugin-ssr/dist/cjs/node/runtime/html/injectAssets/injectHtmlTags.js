...
function injectHtmlFragments(position, htmlFragment, htmlString, injectToStream) {
...
function bundleTags(htmlFragments) {
    const htmlFragmentsBundled = [];
    POSITIONS.forEach((position) => {
        const fragments = htmlFragments.filter((h) => h.position === position).map((h) => h.htmlFragment);
