...
async function injectAssets__public(htmlString, pageContext) {
    ...
    (0, utils_1.assertUsage)((0, utils_1.hasProp)(pageContext, '__getPageAssets'), errMsg('`pageContext.__getPageAssets` is missing'));
    (0, utils_1.assertUsage)((0, utils_1.hasProp)(pageContext, '_passToClient', 'string[]'), errMsg('`pageContext._passToClient` is missing'));
    (0, utils_1.castProp)(pageContext, '__getPageAssets');
    htmlString = await (0, injectAssets_1.injectHtmlTagsToString)([htmlString], pageContext, null);
    return htmlString;
}
