...
async function log404(pageContext) {
    ...
    const { pageRoutes } = await (0, route_1.loadPageRoutes)(pageContext._pageFilesAll, pageContext._pageConfigs, pageContext._allPageIds);
...
function getPagesAndRoutesInfo(pageRoutes) {
    const entries = pageRoutes
        ...
        (0, utils_1.assert)(routeStr && routeTypeSrc && routeDefinedByStr);
