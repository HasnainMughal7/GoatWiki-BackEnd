...
function assertClientEntryId(id) {
    ...
    const isPkg = (0, utils_1.isNpmPackageModule)(id);
    (0, utils_1.assert)(
    // Client entry
    id.startsWith('@@vite-plugin-ssr/') ||
        ...
        id.startsWith('/') ||
        // Code files importer
        (0, virtualIdPageCodeFilesImporter_1.isVirutalModulePageCodeFilesImporter)(id) ||
        // Stem packages
        isPkg, id);
    if (isPkg) {
