...
const virtualModuleIdPageFiles_1 = require("../../plugin/plugins/virtualFiles/virtualModuleIdPageFiles");
...
async function getPageFilesExports() {
    ...
    const result = await transpileaAndLoadModule(virtualModuleIdPageFiles_1.virtualModuleIdPageFilesServer, viteDevServer);
    if ('transpileError' in result) {
        const { transpileError } = result;
        (0, utils_1.debugGlob)(`Glob error: ${virtualModuleIdPageFiles_1.virtualModuleIdPageFilesServer} transpile error: `, transpileError.message);
...
async function transpileaAndLoadModule(moduleId, viteDevServer) {
