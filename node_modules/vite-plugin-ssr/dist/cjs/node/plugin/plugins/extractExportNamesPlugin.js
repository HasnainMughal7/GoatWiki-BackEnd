...
const globalObject = (0, utils_2.getGlobalObject)('extractExportNamesPlugin.ts', {});
...
async function getExtractExportNamesCode(src, isClientSide, isProduction) {
    const { exportNames, wildcardReExports } = await (0, helpers_1.getExportNames)(src);
    ...
    return (0, helpers_1.removeSourceMap)(code);
}
function getCode(exportNames, wildcardReExports, isClientSide, isProduction) {
    let code = '';
...
function addQuery(moduleName) {
    if (moduleName.includes('?')) {
        ...
        (0, utils_1.assert)(fileExtension);
