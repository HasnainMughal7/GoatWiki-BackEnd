...
function getPageFileObject(filePath) {
    ...
    const fileType = (0, fileTypes_1.determineFileType)(filePath);
    const isEnv = (env) => {
        (0, utils_1.assert)(fileType !== '.page.route'); // We can't determine `.page.route.js`
        if (env === 'CLIENT_ONLY') {
    ...
    const pageFile = {
        ...
        isErrorPageFile: (0, route_1.isErrorPageId)(filePath, false),
...
function isDefaultFilePath(filePath) {
    (0, assertPageFilePath_1.assertPageFilePath)(filePath);
    if ((0, route_1.isErrorPageId)(filePath, false)) {
        return false;
    }
...
function isAncestorDefaultPage(pageId, defaultPageFilePath) {
    (0, assertPageFilePath_1.assertPageFilePath)(pageId);
    (0, assertPageFilePath_1.assertPageFilePath)(defaultPageFilePath);
