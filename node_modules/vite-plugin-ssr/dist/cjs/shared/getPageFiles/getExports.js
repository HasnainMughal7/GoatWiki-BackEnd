...
const utils_2 = require("../page-configs/utils");
function getExports(pageFiles, pageConfig) {
    ...
    if (pageConfig) {
        ...
        (0, utils_1.objectEntries)(configValues).forEach(([configName, configValue]) => {
            const exportName = configName;
            const configSrc = (0, utils_2.getSourceFilePath)(pageConfig, configName);
            (0, utils_1.assert)(configSrc);
            exportsAll[exportName] = exportsAll[exportName] ?? [];
            exportsAll[exportName].push({
...
function getExportValues(pageFile) {
    ...
    (0, utils_1.assert)((0, isScriptFile_1.isScriptFile)(filePath));
    const exportValues = [];
    Object.entries(fileExports)
        ...
        if (isFromDefaultExport) {
            if ((0, isScriptFile_1.isTemplateFile)(filePath)) {
                exportName = 'Page';
            }
            else {
...
function getExportUnion(exportsAll, propName) {
    return (exportsAll[propName]
        ?.map((e) => {
        (0, utils_1.assertUsage)((0, utils_1.hasProp)(e, 'exportValue', 'string[]'), `${e.exportSource} should be an array of strings.`);
