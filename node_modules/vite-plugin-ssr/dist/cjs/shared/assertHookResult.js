...
function assertHookResult(hookResult, hookName, hookResultKeys, hookSrc, canBePromise = false) {
    ...
    if ('pageContext' in hookResult) {
        (0, assertPageContextProvidedByUser_1.assertPageContextProvidedByUser)(hookResult['pageContext'], {
