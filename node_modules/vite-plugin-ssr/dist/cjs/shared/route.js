...
exports.getErrorPageId = exports.isErrorPageId = exports.loadPageRoutes = exports.route = void 0;
...
var error_page_1 = require("./route/error-page");
Object.defineProperty(exports, "isErrorPageId", { enumerable: true, get: function () { return error_page_1.isErrorPageId; } });
Object.defineProperty(exports, "getErrorPageId", { enumerable: true, get: function () { return error_page_1.getErrorPageId; } });
const utils_1 = require("./utils");
const addComputedUrlProps_1 = require("./addComputedUrlProps");
const resolvePrecedence_1 = require("./route/resolvePrecedence");
...
const loadPageRoutes_2 = require("./route/loadPageRoutes");
const debug_1 = require("./route/debug");
async function route(pageContext) {
    (0, addComputedUrlProps_1.addComputedUrlProps)(pageContext);
    const { pageRoutes, onBeforeRouteHook } = await (0, loadPageRoutes_2.loadPageRoutes)(pageContext._pageFilesAll, pageContext._pageConfigs, pageContext._allPageIds);
    ...
    await Promise.all(pageRoutes.map(async (pageRoute) => {
        ...
        if (pageRoute.routeType === 'FUNCTION') {
            ...
            const match = await (0, resolveRouteFunction_1.resolveRouteFunction)(routeFunction, allowAsync, pageContext, pageRouteFilePath);
            if (match) {
