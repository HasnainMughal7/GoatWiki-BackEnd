...
async function callOnBeforeRouteHook(onBeforeRouteHook, pageContext) {
    ...
    if ((0, utils_1.hasProp)(hookReturn.pageContext, 'urlOriginal')) {
        (0, utils_1.assertUsage)((0, utils_1.hasProp)(hookReturn.pageContext, 'urlOriginal', 'string'), `${errPrefix} returned \`{ pageContext: { urlOriginal } }\` but \`urlOriginal\` should be a string`);
